...
/* package haskell-individual-0.1.0.0 */
#ifndef VERSION_haskell_individual
#define VERSION_haskell_individual "0.1.0.0"
#endif /* VERSION_haskell_individual */
#ifndef MIN_VERSION_haskell_individual
#define MIN_VERSION_haskell_individual(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_individual */
...
#define CURRENT_COMPONENT_ID "haskell-individual-0.1.0.0-BStHjXrwJ6jBomuroPrAL3-haskell-individual"
